                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form method='post' action="{{ url('admin/update_user',$edit_user->id) }}" class="needs-validation" novalidate  >
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        ...
                                                        <option selected>Choose...</option> 
                                                            ...
                                                            <option value="backoffice" {{ ($edit_user->role) == 'backoffice' ? 'selected' : '' }}>Back Office</option>  
