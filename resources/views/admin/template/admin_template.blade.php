...
<html lang="en" data-layout="vertical" data-topbar="dark" data-sidebar-size="lg" data-sidebar="light" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <link href="{{ asset('admin_file/assets/css/flatpickr.min.css') }}" rel="stylesheet" type="text/css" />
        <!-- App Css-->
    ...
    <body>
        ...
        <!-- CRM js -->
        <!-- <script src="{{ asset('admin_file/assets/js/pages/dashboard-crypto.init.js') }}"></script> -->
        <!-- Dashboard init -->
        <script src="{{ asset('admin_file/assets/js/pages/dashboard-crm.init.js') }}"></script>
        ...
        <!-- App js -->
        <!-- <script src="{{ asset('admin_file/assets/libs/@simonwep/pickr/pickr.min.js') }}"></script> -->
        <!-- init js -->
        <!-- <script src="{{ asset('admin_file/assets/js/pages/form-pickers.init.js') }}"></script> -->
