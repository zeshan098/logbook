        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Immobilienfinanzierung</h4>
                                        ...
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div class="progress-bar "
                                                    role="progressbar"
                                                    style="width: {{$chanel_review_won->percentage}}%; background-color: {{$chanel_review_won->bg_colr}};"
                                    ...
                                    <div class="col">
                                        <div class="p-1">
                                            <div class="progress animated-progress progress-sm">
                                                <div class="progress-bar "
                                                    role="progressbar"
                                                    style="width: {{$chanel_review_lost->percentage}}%; background-color: {{$chanel_review_lost->bg_colr}};"
