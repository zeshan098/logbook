                                    ...
                                    <div class="live-preview">
                                        ...
                                        <input name="_token" id="token" type="hidden" value="{{ csrf_token() }}"/>
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <select class="form-select" name="role" id="role" aria-label="Floating label select example" require> 
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                @foreach($user_list as $user_list)
                                                    <tr>
                                                        ...
                                                        <td class="chanel_name">{{$user_list->role}}</td>
                                                        <td class="chanel_name">{{$user_list->status}}</td>
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a  href="/supervisor/edit_user/{{$user_list->id}}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
