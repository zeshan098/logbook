                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form method='post' action="{{ url('backoffice/update_assign_task', $edit_assign_task->id) }}" class="needs-validation" novalidate action=" ">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        ...
                                                        @foreach($supervisor as $supervisor)
                                                            <option value="{{$supervisor->id}}" {{$edit_assign_task->assign_by == $supervisor->id  ? 'selected' : ''}}>{{$supervisor->name}}</option> 
                                                        @endforeach  
                                                        </select>
