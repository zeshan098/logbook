                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <select class="form-select" name="assign_by" id="assign_by" aria-label="Floating label select example" require> 
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="text-end">
                                                        <button type="submit" id="assign_task_backoffice" class="btn btn-primary">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                @foreach($assigned_task as $assigned_task)
                                                    <tr>
                                                        ...
                                                        <td class="chanel_name">{{$assigned_task->supervisor_name}}</td>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a  href="/backoffice/edit-assign-task/{{$assigned_task->id}}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
