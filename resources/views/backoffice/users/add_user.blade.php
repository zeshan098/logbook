                                    ...
                                    <div class="live-preview">
                                        ...
                                        <input name="_token" id="token" type="hidden" value="{{ csrf_token() }}"/>
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        ...
                                                        @foreach($host_details as $host_details)
                                                            <option value="{{$host_details->id}}">{{$host_details->company_name}}</option> 
                                                        @endforeach  
                                                        </select>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="vocation" name="vocation" placeholder="Enter your Vocation Name" required>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                @foreach($user_list as $user_list)
                                                    <tr>
                                                        ...
                                                        <td class="chanel_name">{{$user_list->company_name}}</td>
                                                        <td class="chanel_name">{{$user_list->vocation}}</td> 
                                                        <td class="chanel_name">{{$user_list->college}}</td> 
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a  href="/backoffice/edit_user/{{$user_list->id}}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
