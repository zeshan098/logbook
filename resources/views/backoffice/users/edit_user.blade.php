                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form method='post' action="{{ url('backoffice/update_user',$edit_user->id) }}" class="needs-validation" novalidate  >
                                        <input name="_token" id="token" type="hidden" value="{{ csrf_token() }}"/>
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <select class="form-select" name="host_id" id="host_id" aria-label="Floating label select example" require> 
                                                        <option selected>Select Host</option>
                                                        @foreach($host_details as $host_details)
                                                            <option value="{{$host_details->id}}" {{$edit_user->host_id == $host_details->id  ? 'selected' : ''}}>{{$host_details->company_name}}</option> 
                                                        @endforeach  
                                                        </select>
                                                        <label for="floatingSelect">Host</label>
                                                         <div class="invalid-feedback">
                                                            Please enter Host
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="vocation" name="vocation" value="{{$edit_user->vocation}}" placeholder="Enter your Channel Name" required>
                                                        <label for="service_name">Vocation</label>
                                                    </div>
                                                    <div class="invalid-feedback">
                                                        Please enter Vocation
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="college" name="college" value="{{$edit_user->college}}" placeholder="Enter your College Name" required>
                                                        <label for="service_name">College</label>
                                                    </div>
                                                    <div class="invalid-feedback">
